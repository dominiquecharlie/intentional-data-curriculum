...
FOUNDATIONS = [
    dict(id="sails-2026",
         ...
         type="foundational",
         curriculum_segments=["toolkit-diagnostic", "toolkit-report", "W1-S1"],
    ...
    dict(id="tir-2026",
         ...
         doi="",
         type="foundational",
         curriculum_segments=["W2-S2", "W3-S1", "toolkit-sorting"],
    ...
    dict(id="care-model",
         ...
         doi="",
         type="foundational",
         curriculum_segments=["W1-S2", "W3-S1", "toolkit-rubric"],
    ...
    dict(id="nist-airmf",
         ...
         doi="",
         type="standard",
         curriculum_segments=["W2-S2", "toolkit-charter"],
    ...
    dict(id="australia-principles",
         ...
         doi="",
         type="foundational",
         curriculum_segments=["W1-S2", "W3-S1", "toolkit-sorting"],
    ...
    dict(id="anthropic-exponential",
         ...
         doi="",
         type="policy",
         curriculum_segments=["W2-S1", "toolkit-charter"],
